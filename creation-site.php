...
<link rel="stylesheet" href="css/style-creation-site.css">
...
<!--*********************************************************************************************************-->
 ...
 <div class="plusdinfo">
    ...
    <div class="contenu">
        <img src="image/creation-site1.jpg">
        <div class="text">
            <h1>Création site web  pas cher</h1>
            Vous avez besoin d’un site web professionnel, adaptatif ( responsive design ), 
            sécuriser et bien classer sur tous les moteurs de recherche .<br>
    ...
    <div class="contenu">
         ...
         <img src="image/creation-site2.jpg">
    </div>
   
   <a href="commande.php?type=site web">PASSER UNE COMMANDE</a>
</div>
<!--*********************************************************************************************************-->
<!--**********************************   Fin    creation    site  **************************************-->
<!--*********************************************************************************************************-->
