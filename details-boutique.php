...
<link rel="stylesheet" href="css/style-details-boutique.css">
...
<div class="details">
 ...
 <!--**********  Début Image Silder  ************-->
    <div class="detail-1"> 
        <img src="image/produits/<?php  echo  $resultat->image; ?> " alt="">
        <div class="text-1">
            <h2><?php  echo  $resultat->nom; ?></h2>
            <?php  echo  $resultat->description; ?> 
            <div class="price">
                <h2><?php  echo  $resultat->prix; ?> euro</h2> 
            </div>
            <a href="panier.php?action=ajout&amp;l=<?php  echo  $resultat->nom; ?>&amp;q=1&amp;p=<?php  echo  $resultat->prix; ?>" onclick="window.open(this.href, '', 
            'toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=yes, copyhistory=no, width=700, height=500'); return false;">Ajouter au panier</a>
        </div>
    </div>
    <div class="detail-2">
        ...
        <div class="fiche-technique">
            <div class="caracteristique">
                <ul> 
                    <?php if ($resultat->titre_1!="" ){
                    echo "<li> $resultat->titre_1 </li>"; }?> <br>
                    <?php if ($resultat->titre_2!="" ){
                    echo "<li> $resultat->titre_2 </li>"; }?> <br>
                    <?php if ($resultat->titre_3!="" ){
                    echo "<li> $resultat->titre_3 </li>"; }?> <br>
                    <?php if ($resultat->titre_4!="" ){
                    echo "<li> $resultat->titre_4 </li>"; }?> <br>
                    <?php if ($resultat->titre_5!="" ){
                    echo "<li> $resultat->titre_5 </li>"; }?> <br>
                    <?php if ($resultat->titre_6!="" ){
                    echo "<li> $resultat->titre_6 </li>"; }?> <br>
                    <?php if ($resultat->titre_7!="" ){
                    echo "<li> $resultat->titre_7 </li>"; }?> <br>
                    <?php if ($resultat->titre_8!="" ){
                    echo "<li> $resultat->titre_8 </li>"; }?> <br>
                    <?php if ($resultat->titre_9!="" ){
                    echo "<li> $resultat->titre_9 </li>"; }?> <br>
                    <?php if ($resultat->titre_10!="" ){
                    echo "<li> $resultat->titre_10 </li>"; }?> <br>

                </ul>
            </div>
            <div class="info">
                <ul>
                    <?php if ($resultat->text_1!="" ){
                    echo "<li> $resultat->text_1 </li>"; }?> <br>
                    <?php if ($resultat->text_2!="" ){
                    echo "<li> $resultat->text_2 </li>"; }?> <br>
                    <?php if ($resultat->text_3!="" ){
                    echo "<li> $resultat->text_3 </li>"; }?> <br>
                    <?php if ($resultat->text_4!="" ){
                    echo "<li> $resultat->text_4 </li>"; }?> <br>
                    <?php if ($resultat->text_5!="" ){
                    echo "<li> $resultat->text_5 </li>"; }?> <br>
                    <?php if ($resultat->text_6!="" ){
                    echo "<li> $resultat->text_6 </li>"; }?> <br>
                    <?php if ($resultat->text_7!="" ){
                    echo "<li> $resultat->text_7 </li>"; }?> <br>
                    <?php if ($resultat->text_8!="" ){
                    echo "<li> $resultat->text_8 </li>"; }?> <br>
                    <?php if ($resultat->text_9!="" ){
                    echo "<li> $resultat->text_9 </li>"; }?> <br>
                    <?php if ($resultat->text_10!="" ){
                    echo "<li> $resultat->text_10 </li>"; }?> <br>
                </ul>
            </div>
        </div>
    </div>
