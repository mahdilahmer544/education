...
<div class="ajouter">
    ...
    <form method="post" action="" enctype="multipart/form-data">
        <input type="hidden" name="id"  value="<?php echo $resultat->id_blog; ?>"> <br>
         image 
         <input type="file" name="avatar" >
         titre principal <br>
         <input type="text" name="titre-princ"  value="<?php echo $resultat->titre_principal; ?>" required> <br>
         text principal <br>
         <input type="text" name="text-princ"  value="<?php echo $resultat->text_principal; ?>" required> <br>
         titre-1 <br>
    ...
    <?php
      ...
      $text6=str_replace("'", "", $_POST["text-6"]);
		...
		$query = "update blog set  `titre_principal`='".$titre_princ."', 
        `text_principal`='".$text_princ."', `titre_1`='".$titre1."', 
        ...
        `titre_6`='".$titre6."', `text_6`='".$text6."' where `id_blog`='".$_POST["id"]."'  ";
     ...
     if(!in_array($extension, $extensions)) //Si l'extension n'est pas dans le tableau
    {
     ...
     if(move_uploaded_file($_FILES['avatar']['tmp_name'], $dossier . $fichier)) //Si la fonction renvoie TRUE, c'est que ça a fonctionné...
     {
       ...
       $query = "update blog set  `titre_principal`='".$titre_princ."', 
           ...
           `titre_3`='".$titre3."', `text_3`='".$text3."', `titre_4`='".$titre4."',
           `text_4`='".$text4."', `titre_5`='".$titre5."', `text_5`='".$text5."', 
           `titre_6`='".$titre6."', `text_6`='".$text6."',`image`='".$fichier."'  where `id_blog`='".$_POST["id"]."'  ";
     }
     ...
     echo $erreur;
		 ...
		 if ( $resultat =$connexion->query($query )) 
		{
			...
			header('Location:blog-admin.php?modifier=oui');
		}
		
		else
			{
				header("Location: blog-admin.php?modifier=non");
		}
