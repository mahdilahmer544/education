...
<link rel="stylesheet" href="css/style-read-more-blog.css">
...
<!--*********************************************************************************************************-->
 ...
 <!--*********************************************************************************************************-->
 <!--**********************************   Début read-more blog   **************************************-->
 <!--*********************************************************************************************************-->

<?php
include( "connexion.php" );
$resultats = $connexion->query( "SELECT * from blog where id_blog='".$_GET["id"]."'" );
$resultats->setFetchMode( PDO::FETCH_OBJ );
$resultat = $resultats->fetch() ;
?>
 <div class="read-more">
    <div class="titre1">
           <h1><?php  echo  $resultat->titre_principal; ?></h1>
    </div>
    <div class="text-1">
        <img src="image/<?php  echo  $resultat->image; ?>"> 
        <div class="text">
            <h1><?php  echo  $resultat->titre_1; ?></h1>
             <?php  echo  $resultat->text_1; ?>
        </div>
    </div>
    <div class="text-2">
        <h1><?php  echo  $resultat->titre_2; ?></h1>
        <?php  echo  $resultat->text_2; ?>
        <h1><?php  echo  $resultat->titre_3; ?></h1>
        <?php  echo  $resultat->text_3; ?>
        <h1><?php  echo  $resultat->titre_4; ?></h1>
        <?php  echo  $resultat->text_4; ?>
        <h1><?php  echo  $resultat->titre_5; ?></h1>
        <?php  echo  $resultat->text_5; ?>
        <h1><?php  echo  $resultat->titre_6; ?></h1>
        <?php  echo  $resultat->text_6; ?>
    </div>
